...
public interface BrokerPortType {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "provaDeVida", targetNamespace = "http://ws.broker.upa.pt/", className = "pt.upa.broker.ws.ProvaDeVida")
    @ResponseWrapper(localName = "provaDeVidaResponse", targetNamespace = "http://ws.broker.upa.pt/", className = "pt.upa.broker.ws.ProvaDeVidaResponse")
    @Action(input = "http://ws.broker.upa.pt/BrokerPort/provaDeVidaRequest", output = "http://ws.broker.upa.pt/BrokerPort/provaDeVidaResponse")
    public String provaDeVida(
        @WebParam(name = "name", targetNamespace = "")
        String name);
    ...
    public void update(
        @WebParam(name = "tv", targetNamespace = "")
        TransportView tv,
