 ...
 * 
 */
@WebServiceClient(name = "BrokerService", targetNamespace = "http://ws.broker.upa.pt/", wsdlLocation = "file:/home/facas/SD_trab/T_46-project/broker-ws/src/main/resources/broker.1_0.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/home/facas/SD_trab/T_46-project/broker-ws/src/main/resources/broker.1_0.wsdl");
