...
public class ObjectFactory {
    ...
    private final static QName _ProvaDeVida_QNAME = new QName("http://ws.broker.upa.pt/", "provaDeVida");
    private final static QName _UpdateResponse_QNAME = new QName("http://ws.broker.upa.pt/", "updateResponse");
    ...
    private final static QName _Update_QNAME = new QName("http://ws.broker.upa.pt/", "update");
    ...
    private final static QName _ProvaDeVidaResponse_QNAME = new QName("http://ws.broker.upa.pt/", "provaDeVidaResponse");
    ...
    /**
     * Create an instance of {@link ProvaDeVidaResponse }
     * 
     */
    public ProvaDeVidaResponse createProvaDeVidaResponse() {
        return new ProvaDeVidaResponse();
    }
    ...
    /**
     * Create an instance of {@link ProvaDeVida }
     * 
     */
    public ProvaDeVida createProvaDeVida() {
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ProvaDeVida }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://ws.broker.upa.pt/", name = "provaDeVida")
    public JAXBElement<ProvaDeVida> createProvaDeVida(ProvaDeVida value) {
        return new JAXBElement<ProvaDeVida>(_ProvaDeVida_QNAME, ProvaDeVida.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.broker.upa.pt/", name = "updateResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.broker.upa.pt/", name = "update")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ProvaDeVidaResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://ws.broker.upa.pt/", name = "provaDeVidaResponse")
    public JAXBElement<ProvaDeVidaResponse> createProvaDeVidaResponse(ProvaDeVidaResponse value) {
        return new JAXBElement<ProvaDeVidaResponse>(_ProvaDeVidaResponse_QNAME, ProvaDeVidaResponse.class, null, value);
    }
